...
$(document).ready(function() {
  ...
  if (revenue !== null) {
    var revenueData = [
      {
        first: [0, 65, 52, 115, 98, 165, 125, 54, 84, 195, 62, 120],
        second: [45, 38, 100, 87, 152, 187, 85, 185, 195, 39, 112, 95]
      },
      {
        first: [0, 65, 52, 115, 98, 165, 125, 54, 84, 195, 62, 120],
        second: [45, 38, 100, 87, 152, 187, 85, 185, 195, 39, 812, 95]
      },
      {
        first: [0, 65, 52, 115, 98, 165, 125, 54, 84, 195, 62, 120],
        second: [45, 38, 100, 87, 152, 187, 85, 185, 195, 39, 812, 95]
    ...
    var items = document.querySelectorAll("#user-revenue .nav-tabs .nav-item");
    items.forEach(function(item, index){
      item.addEventListener("click", function() {
  ...
  if (deviceChart !== null) {
    var mydeviceChart = new Chart(deviceChart, {
      type: "doughnut",
      data: {
        labels: ["Bug", "Questions", "Ne Installation","Support"],
        datasets: [
          {
            label: ["Bug", "Questions", "Ne Installation", "Support" ],
            data: [25000, 25000, 20000, 30000],
            backgroundColor: [
              "#FF0000",
              "#FF8040",
              "#009700",
